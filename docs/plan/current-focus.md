...
| Старые ветки (`feature/audit-fixes-20260317`, `feature/2026-03-15-session`) | 🟡 Смержить аудит / архивировать старую ветку — **по команде** |
...
*Последнее обновление: 2026-03-22 (конец сессии) — ниже добавлено напоминание про параллельный контур «сценарий жизни СТ».*
