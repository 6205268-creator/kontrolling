...
""",
    ...
    openapi_tags=[
        ...
        },
        {
            ...
            "description": "Распределение платежей: лицевые счета, операции, распределение по задолженностям, настройки правил.",
        },
        {
            "name": "expenses",
...
app.include_router(
    payment_distribution_router, prefix="/api/payment-distribution", tags=["payment-distribution"]
)
