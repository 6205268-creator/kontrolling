...
# Сущность -> (History-модель, имена колонок-снимка без id/created_at/updated_at и т.д.)
_HISTORY_CONFIG: list[tuple[type, type, list[str]]] = [
    (
        PlotOwnership,
        PlotOwnershipHistory,
        [
...
def register_history_events() -> None:
    ...
    for entity_class, history_class, snapshot_columns in _HISTORY_CONFIG:
