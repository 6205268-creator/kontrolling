...
class Payment(Base):
    ...
    payer_owner_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("owners.id"), nullable=False, index=True)
    ...
    financial_subject: Mapped["FinancialSubject"] = relationship("FinancialSubject", back_populates="payments")
